...
\usepackage{lmodern}
\usepackage{fontspec}
\setmonofont{DejaVu Sans Mono} % Monospace (req. Unicode support)
...
\figuremacroW{7_appendixes/image01}{Title of Figure}{Description. [Source: (\cite{mydownloadedimage})]}{0.8}
